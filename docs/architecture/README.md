...
| **Quản Lý State & Deploy Topology** | [04_STATE_MANAGEMENT_AND_DEPLOY.md](04_STATE_MANAGEMENT_AND_DEPLOY.md) | LangGraph.js 17 Trạng Thái Chuẩn Hóa với Postgres Checkpointer SSOT, VPS Docker Compose Caddy File Spec. |
...
```
         ...
         │  (Next.js 14 App Router)    ├──────────────────────►│ (Remotion / Chromium Engine)│
         └──────────────┬──────────────┘       BullMQ Task     └──────────────┬──────────────┘
                        │                        Queue                        │
                        ▼                                                     ▼
         ┌─────────────────────────────┐                       ┌─────────────────────────────┐
