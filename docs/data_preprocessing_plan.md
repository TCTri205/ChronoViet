...
#### [NEW] [visual-asset-ingestor.ts](../packages/data-ingestion/src/media/visual-asset-ingestor.ts)
...
#### [NEW] [audio-asset-ingestor.ts](../packages/data-ingestion/src/media/audio-asset-ingestor.ts) & Integrated `setup-assets` Script
...
#### [NEW] [cli/setup-assets.ts](../packages/data-ingestion/src/cli/setup-assets.ts) & [setup_assets.js](../packages/remotion-engine/eval/scripts/setup_assets.js)
