...
export const DEITY_TITLE_MAPPINGS: Record<string, { canonicalId: string; canonicalName: string }> = {
  ...
  'thục vương': { canonicalId: 'person_an_duong_vuong', canonicalName: 'An Dương Vương' },
  'trưng nữ vương': { canonicalId: 'person_trung_trac', canonicalName: 'Trưng Trắc' },
  'trưng trắc': { canonicalId: 'person_trung_trac', canonicalName: 'Trưng Trắc' },
  'trưng nhị': { canonicalId: 'person_trung_nhi', canonicalName: 'Trưng Nhị' },
  'anh hùng áo vải': { canonicalId: 'person_quang_trung', canonicalName: 'Quang Trung' },
  'áo vải cờ đào': { canonicalId: 'person_quang_trung', canonicalName: 'Quang Trung' },
  'hùm xám yên thế': { canonicalId: 'person_hoang_hoa_tham', canonicalName: 'Hoàng Hoa Thám' },
  'đề thám': { canonicalId: 'person_hoang_hoa_tham', canonicalName: 'Hoàng Hoa Thám' },
  'bình tây đại nguyên soái': { canonicalId: 'person_truong_dinh', canonicalName: 'Trương Định' },
  'vạn thế sư biểu': { canonicalId: 'person_chu_van_an', canonicalName: 'Chu Văn An' },
  'trạng trình': { canonicalId: 'person_nguyen_binh_khiem', canonicalName: 'Nguyễn Bỉnh Khiêm' },
  'bạch vân cư sĩ': { canonicalId: 'person_nguyen_binh_khiem', canonicalName: 'Nguyễn Bỉnh Khiêm' },
  'trạng bùng': { canonicalId: 'person_phung_khac_khoan', canonicalName: 'Phùng Khắc Khoan' },
  'phật hoàng': { canonicalId: 'person_tran_nhan_tong', canonicalName: 'Trần Nhân Tông' },
  'trúc lâm đại đầu đà': { canonicalId: 'person_tran_nhan_tong', canonicalName: 'Trần Nhân Tông' },
  'bà chúa thơ nôm': { canonicalId: 'person_ho_xuan_huong', canonicalName: 'Hồ Xuân Hương' },
  'cụ đồ chiểu': { canonicalId: 'person_nguyen_dinh_chieu', canonicalName: 'Nguyễn Đình Chiểu' },
  'chị út tịch': { canonicalId: 'person_nguyen_thi_ut', canonicalName: 'Nguyễn Thị Út' },
  'chị sáu': { canonicalId: 'person_vo_thi_sau', canonicalName: 'Võ Thị Sáu' },
  'bác tôn': { canonicalId: 'person_ton_duc_thang', canonicalName: 'Tôn Đức Thắng' },
  'bác hồ': { canonicalId: 'person_ho_chi_minh', canonicalName: 'Hồ Chí Minh' },
  'cụ hồ': { canonicalId: 'person_ho_chi_minh', canonicalName: 'Hồ Chí Minh' },
  'tướng giáp': { canonicalId: 'person_vo_nguyen_giap', canonicalName: 'Võ Nguyên Giáp' },
  'bác giáp': { canonicalId: 'person_vo_nguyen_giap', canonicalName: 'Võ Nguyên Giáp' },
  'mẹ suốt': { canonicalId: 'person_nguyen_thi_suot', canonicalName: 'Nguyễn Thị Suốt' },
  'mẹ thứ': { canonicalId: 'person_nguyen_thi_thu', canonicalName: 'Nguyễn Thị Thứ' },
  'chúa sãi': { canonicalId: 'person_nguyen_phuc_nguyen', canonicalName: 'Nguyễn Phúc Nguyên' },
  'dạ trạch vương': { canonicalId: 'person_trieu_quang_phuc', canonicalName: 'Triệu Quang Phục' },
};
...
export const HISTORICAL_CHRONOLOGY: HistoricalEpochRange[] = [
  ...
  { epochId: 'EPOCH_10', dynastyId: 'dynasty_nha_tay_son', name: 'Nhà Tây Sơn', dynastyName: 'Nhà Tây Sơn', startYear: 1778, endYear: 1801 },
