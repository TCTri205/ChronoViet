...
export const EnvSchema = z.object({
  ...
  LOCAL_LLM_KV_CACHE_TYPE: z.string().default('q8_0'),
  ...
  LOCAL_LLM_EXTRACTION_CTX_SIZE: z.coerce.number().int().positive().default(114688),
  LOCAL_LLM_EXTRACTION_PARALLEL: z.coerce.number().int().positive().default(14),
  LOCAL_LLM_EXTRACTION_THREADS: z.coerce.number().int().positive().default(14),
  LOCAL_LLM_EXTRACTION_EXTRA_ARGS: z.string().optional(),
  EMBEDDING_PORT: z.coerce.number().int().positive().default(8090),
  EMBEDDING_CTX_SIZE: z.coerce.number().int().positive().default(32768),
  EMBEDDING_EXTRA_ARGS: z.string().optional(),
  LOCAL_EMBEDDING_PARALLEL: z.coerce.number().int().positive().default(2),
