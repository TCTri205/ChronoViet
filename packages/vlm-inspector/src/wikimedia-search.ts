...
import { ImageSearchProvider } from './search/image-search-provider.js';
 ...
 * Wraps the legacy `searchWikimediaCommons` function.
 */
...
export class CuratedCatalogProvider implements ImageSearchProvider {
  ...
  async search(_keywords: string, limit: number): Promise<VisualCandidate[]> {
