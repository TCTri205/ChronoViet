 ...
 */
export function getMergedTheme(templateId?: TemplateId, customTheme?: Partial<ThemeConfig>, videoType?: VideoDomain): ResolvedTheme {
 ...
 */
export function resolveTheme(theme?: Partial<ThemeConfig> | null): ResolvedTheme {
  return {
