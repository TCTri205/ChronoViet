...
export async function runC0Benchmark(): Promise<ComponentBenchmarkReport> {
  ...
  const testCorpora = [
    {
      ...
      expectedRelations: ['ALIAS_OF', 'PART_OF'],
    },
    {
    ...
    },
    {
      ...
      expectedRelations: ['LED_BY', 'HAPPENED_IN'],
    },
    {
    ...
    },
    {
      ...
      expectedRelations: ['LED_BY', 'ALIAS_OF', 'HAPPENED_AT'],
    },
    {
    ...
    },
    {
      ...
      expectedEntities: ['person_le_loi', 'person_nguyen_trai', 'person_le_thanh_tong'],
      expectedRelations: ['LED_BY', 'ALIAS_OF', 'HAPPENED_IN'],
    },
    {
    ...
    },
    {
      ...
      expectedEntities: ['person_nguyen_hoang', 'person_dao_duy_tu', 'person_trinh_kiem'],
      expectedRelations: ['ALIAS_OF', 'HAPPENED_IN'],
    },
    {
      ...
      expectedEntities: ['person_quang_trung', 'person_nguyen_nhac'],
      expectedRelations: ['LED_BY', 'ALIAS_OF', 'HAPPENED_AT'],
    },
    {
    ...
    },
    {
      ...
      expectedRelations: ['LED_BY', 'HAPPENED_AT', 'HAPPENED_IN'],
    }
  ];
  ...
  const recallEntity = Math.min(100, (trueEntities / Math.max(1, goldEntityCount * 2)) * 100);
  ...
  const recallRelation = Math.min(100, (correctRelations / Math.max(1, goldRelationCount)) * 100);
