 ...
 * Usage: pnpm setup-assets or pnpm --filter @chronoviet/rag-engine setup-assets
 */

import path from 'path';
import { promises as fs } from 'fs';
import { VisualAssetIngestor } from '../ingestion/media/visual-asset-ingestor.js';
import { AudioAssetIngestor } from '../ingestion/media/audio-asset-ingestor.js';
