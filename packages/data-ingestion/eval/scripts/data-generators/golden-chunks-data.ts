...
export const GOLDEN_CHUNKS_DATA: ChunkInput[] = [
  ...
  // =========================================================================
  // ENRICHED PRODUCTION CHUNKS (LEGAL, ECONOMIC, MARITIME & CULTURAL REVOLUTION)
  // =========================================================================
  {
    "id": "CHUNK_ENRICH_001_HO_QUY_LY_TIEN_GIAY",
    "epochId": "EPOCH_06",
    "sourceDocument": "Đại Việt Sử Ký Toàn Thư & Lịch Sử Kinh Tế Việt Nam",
    "dynasty": "Nhà Hồ",
    "sectionTitle": "Cải cách tiền tệ và ban hành tiền giấy Thông bảo hội sao năm 1396",
    "evaluationFocus": "MONETARY_POLICY_PAPER_CURRENCY",
    "banner": "[Sử Liệu: Đại Việt Sử Ký Toàn Thư] [Kỷ/Triều Đại: Nhà Hồ] [Mục: Phát hành tiền giấy Thông bảo hội sao] [Nhân Vật: Hồ Quý Ly, Hồ Hán Thương] [Thời Gian: Năm 1396 - 1403]",
    "rawText": "Tháng 4 năm 1396 dưới triều vua Trần Thuận Tông, Hồ Quý Ly khi nắm toàn quyền phụ chính đã khởi xướng cuộc cải cách tiền tệ quy mô lớn chưa từng có trong lịch sử Đại Việt bằng việc ban hành tiền giấy Thông bảo hội sao. Triều đình ra lệnh cho toàn dân đem tiền đồng đổi lấy tiền giấy với tỷ lệ một quan tiền đồng đổi lấy một quan hai tiền giấy, đồng thời nghiêm cấm tuyệt đối việc tàng trữ hoặc sử dụng lén lút tiền đồng trong nhân dân. Toàn bộ tiền đồng thu hồi được tập trung cất giữ tại kho Ngao Trì ở kinh đô Thăng Long và trị sở các lộ nhằm phục vụ ngân khố quốc gia và đúc súng thần công phục vụ quốc phòng. Thể thức in tiền giấy được quy định rất mỹ thuật và chặt chẽ: tờ mười đồng vẽ hình rau rong, tờ ba mươi đồng vẽ sóng nước, tờ một tiền vẽ mây trời, tờ hai tiền vẽ rùa thần, tờ ba tiền vẽ kỳ lân, tờ năm tiền vẽ chim phượng và tờ một quan vẽ rồng vàng uốn khúc. Kẻ nào làm giả tiền giấy hoặc từ chối tiêu tiền giấy đều bị khép vào trọng tội tử hình và tịch thu toàn bộ gia sản. Đến năm 1401, vua Hồ Hán Thương lập ra kho Thường Bình tại các lộ, cấp tiền giấy mua thóc lúa dự trữ để bình ổn giá lương thực trên thị trường. Tuy nhiên do công nghệ in ấn thời bấy giờ còn sơ khai, tiền giấy dễ bị ẩm ướt, mục nát và dễ bị làm giả khiến nhân dân và thương nhân giảm sút lòng tin vào giá trị đồng tiền pháp định, dẫn đến tình trạng hàng đổi hàng cục bộ trong xã hội phong kiến đương thời.",
    "wordCount": 336,
    "entities": [
      {
        "id": "person_ho_quy_ly",
  ...
  {
    "id": "CHUNK_ENRICH_002_LE_THANH_TONG_LUAT_HONG_DUC",
    "epochId": "EPOCH_08",
    "sourceDocument": "Đại Việt Sử Ký Toàn Thư & Lịch Sử Pháp Quyền Đại Việt",
    "dynasty": "Nhà Lê Sơ",
    "sectionTitle": "Ban hành bộ Quốc triều hình luật và xác lập chế độ khắc bia tiến sĩ năm 1484",
    "evaluationFocus": "LEGAL_INSTITUTION_EDUCATION",
    "banner": "[Sử Liệu: Đại Việt Sử Ký Toàn Thư] [Kỷ/Triều Đại: Nhà Lê Sơ] [Mục: Luật Hồng Đức và Bia Tiến Sĩ] [Nhân Vật: Lê Thánh Tông, Ngô Sĩ Liên] [Thời Gian: Năm 1483 - 1484]",
    "rawText": "Năm 1483, hoàng đế Lê Thánh Tông ban hành bộ Quốc triều hình luật, thường được gọi là Luật Hồng Đức, gồm sáu quyển với 722 điều khoản pháp lý mẫu mực. Đây là bộ luật hoàn thiện nhất và tiến bộ nhất trong lịch sử lập pháp phong kiến Đại Việt, đánh dấu sự hình thành của một thiết chế nhà nước pháp quyền sơ khởi lấy tư tưởng nhân nghĩa Nho giáo kết hợp với truyền thống dân tộc làm nền tảng quản trị quốc gia. Luật Hồng Đức đặc biệt chú trọng bảo vệ quyền lợi phụ nữ, quyền sở hữu tài sản hương hỏa của gia đình và quy định nghiêm minh trách nhiệm xét xử công bằng của đội ngũ quan lại tư pháp. Song song với việc hoàn thiện luật pháp, năm 1484 vua Lê Thánh Tông khởi xướng cho dựng 82 tấm bia tiến sĩ đầu tiên tại Văn Miếu Quốc Tử Giám nhằm vinh danh các bậc hiền tài đỗ đại khoa kể từ khoa thi Nhâm Tuất năm 1442 thời Lê Thái Tông mà sử quan Ngô Sĩ Liên là một trong những vị tiến sĩ đỗ đầu bảng. Sử thần Thân Nhân Trung khi soạn văn bia đã khắc sâu chân lý bất hủ: Hiền tài là nguyên khí của quốc gia, nguyên khí thịnh thì thế nước mạnh rồi lên cao, nguyên khí suy thì thế nước yếu rồi xuống thấp. Hệ thống giáo dục khoa cử và pháp luật thời Hồng Đức đã tạo nên một nền văn hiến rực rỡ và kỷ cương phép nước nghiêm minh suốt thời kỳ thịnh trị bậc nhất của triều đại Lê Sơ.",
    "wordCount": 322,
    "entities": [
      {
        "id": "person_le_thanh_tong",
    ...
    "triples": [
      {
        ...
        "subjectName": "Lê Thánh Tông",
        "relationType": "PART_OF",
        "objectId": "dynasty_le_so",
        "objectName": "Nhà Lê Sơ"
      }
    ]
  },
  {
    "id": "CHUNK_ENRICH_003_TRIEU_NGUYEN_HOANG_SA_PHAM_HUU_NHAT",
    "epochId": "EPOCH_11",
    "sourceDocument": "Quốc Triều Chánh Biên Toát Yếu & Đại Nam Thực Lục",
    "dynasty": "Nhà Nguyễn",
    "sectionTitle": "Hoạt động thực thi chủ quyền của Đội Hoàng Sa và Thủy quân Suất đội Phạm Hữu Nhật",
    "evaluationFocus": "MARITIME_SOVEREIGNTY_HISTORICAL_EVIDENCE",
    "banner": "[Sử Liệu: Quốc Triều Chánh Biên Toát Yếu] [Kỷ/Triều Đại: Nhà Nguyễn] [Mục: Khảo sát và dựng bia chủ quyền Hoàng Sa] [Nhân Vật: Minh Mạng, Phạm Hữu Nhật] [Thời Gian: Năm 1836]",
    "rawText": "Dưới triều vua Minh Mạng, công cuộc quản lý và khẳng định chủ quyền cương vực biển đảo của nhà nước Đại Nam được tổ chức quy củ và chặt chẽ trên quy mô lớn. Năm 1836, hoàng đế chuẩn y tờ tấu của Bộ Công, phái Thủy quân Suất đội Phạm Hữu Nhật dẫn đầu các đội thuyền chiến cùng biền binh tỉnh Quảng Ngãi thẳng tiến ra quần đảo Hoàng Sa để tiến hành đo đạc hải trình, khảo sát địa hình các cồn cát, bãi đá ngầm và vẽ thành đồ bản địa lý chi tiết dâng lên triều đình ngự lãm. Suất đội Phạm Hữu Nhật phụng mệnh mang theo bài gỗ chuẩn bị sẵn đóng cọc làm mốc, khắc chữ ghi rõ năm hiệu Minh Mạng thứ mười bảy vạn lý ba bình để khẳng định mốc giới cương thổ thiêng liêng trên biển Đông. Trước đó triều đình đã cho xây dựng đền miếu và dựng bia đá uy nghiêm trên cồn cát Hoàng Sa, đồng thời trao quyền hạn cho Đội Hoàng Sa và Đội Bắc Hải tuần tiễu định kỳ, thu lượm hải vật, cứu hộ tàu buôn nước ngoài gặp nạn và bảo vệ tuyến giao thương huyết mạch trên biển. Những hoạt động liên tục và hòa bình được ghi chép tỉ mỉ trong chính sử Quốc Triều Chánh Biên Toát Yếu và Đại Nam Thực Lục là bằng chứng pháp lý và lịch sử đanh thép, vô giá khẳng định chủ quyền lâu đời không thể tranh cãi của dân tộc Việt Nam đối với hai quần đảo Hoàng Sa và Trường Sa.",
    "wordCount": 319,
    "entities": [
      {
        "id": "person_minh_mang",
    ...
    "triples": [
      {
        "subjectId": "person_pham_huu_nhat",
        "subjectName": "Phạm Hữu Nhật",
        "relationType": "HAPPENED_AT",
        "objectId": "loc_hoang_sa",
        "objectName": "Hoàng Sa"
      }
    ]
  },
  {
    "id": "CHUNK_ENRICH_004_DE_CUONG_VAN_HOA_1943_THO_MOI",
    "epochId": "EPOCH_12",
    "sourceDocument": "Văn Kiện Đảng Toàn Tập & Chuyên Khảo Lịch Sử Văn Hóa",
    "dynasty": "Thời kỳ Cận Đại",
    "sectionTitle": "Đề cương Văn hóa Việt Nam 1943 và phong trào cách mạng văn hóa giải phóng dân tộc",
    "evaluationFocus": "CULTURAL_REVOLUTION_PRINCIPLES",
    "banner": "[Sử Liệu: Văn Kiện Đảng] [Kỷ/Triều Đại: Pháp thuộc cận đại] [Mục: Đề cương Văn hóa 1943] [Nhân Vật: Trường Chinh, Hoài Thanh, Thế Lữ] [Thời Gian: Tháng 2/1943]",
    "rawText": "Tháng 2 năm 1943 tại Hội nghị Võng La, Tổng Bí thư Ban Chấp hành Trung ương Đảng Trường Chinh trực tiếp chấp bút và thông qua bản Đề cương Văn hóa Việt Nam, văn kiện lý luận có ý nghĩa cương lĩnh văn hóa đầu tiên của cách mạng dân tộc. Đề cương xác định văn hóa là một trong ba mặt trận cốt yếu bên cạnh mặt trận chính trị và mặt trận kinh tế, đồng thời đề ra ba nguyên tắc vận động văn hóa mới mang tính chiến lược: Dân tộc hóa nhằm chống lại chính sách nô dịch văn hóa của phát xít Pháp Nhật, Đại chúng hóa nhằm đưa văn hóa phụng sự đông đảo quần chúng nhân dân lao động, và Khoa học hóa nhằm quét sạch tư tưởng phong kiến hủ bại mê tín dị đoan để tiếp thu tinh hoa khoa học hiện đại. Dưới sự soi đường của Đề cương, cuối năm 1943 Hội Văn hóa Cứu quốc Việt Nam chính thức được thành lập, quy tụ đông đảo các nhà văn, nhà thơ và trí thức lớn của phong trào Thơ Mới như Thế Lữ, Hoài Thanh, Nam Cao, Tô Hoài, Văn Cao cùng đồng lòng tham gia hàng ngũ Mặt trận Việt Minh. Cuộc cách mạng văn hóa đã thổi bùng ngọn lửa yêu nước nồng nàn trong giới văn nghệ sĩ và quần chúng nhân dân, chuẩn bị xung lực tư tưởng to lớn dẫn tới thắng lợi vĩ đại của cuộc Cách mạng Tháng Tám năm 1945.",
    "wordCount": 287,
    "entities": [
      {
        "id": "person_truong_chinh",
    ...
    "triples": [
      {
        "subjectId": "person_the_lu",
        "subjectName": "Thế Lữ",
        "relationType": "PART_OF",
        "objectId": "org_hoi_van_hoa_cuu_quoc",
        "objectName": "Hội Văn hóa Cứu quốc Việt Nam"
      }
    ]
  }
];
