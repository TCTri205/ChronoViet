...
import { stripNegativeSearchTerms, AllowedVisualLicense, normalizeLicenseString } from "./wikimedia-search.js";
...
export const HISTORICAL_FALLBACK_CATALOG: CuratedHistoricalAsset[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/be/C%E1%BB%95ng_%C4%91%E1%BB%81n_H%C3%B9ng_%28Ph%C3%BA_Th%E1%BB%8D%29.jpg',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:C%E1%BB%95ng_%C4%91%E1%BB%81n_H%C3%B9ng_%28Ph%C3%BA_Th%E1%BB%8D%29.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/16/Co_loa_Citadel.jpg',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Co_loa_Citadel.jpg',
  ...
  },
  {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/fe/Muiten.jpg',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Muiten.jpg',
  ...
  // =========================================================================
  {
    ...
    topicKeywords: ['ngô quyền', 'bạch đằng 938', 'trận bạch đằng 938', 'bãi cọc bạch đằng 938', 'nam hán', 'tiền ngô vương'],
  ...
  },
  {
    ...
    epochKey: 'EPOCH_NGO_DINH_TIEN_LE',
    topicKeywords: ['bạch đằng 981', 'hầu nhân bảo', 'lê hoàn đánh tống', 'sông bạch đằng 981'],
    title: 'Đền thờ vua Lê Đại Hành tại Cố đô Hoa Lư ghi nhớ chiến công Bạch Đằng 981',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Den_vua_Le_Dai_Hanh.jpg',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Den_vua_Le_Dai_Hanh.jpg',
    author: 'Hội Sử học Việt Nam',
    license: 'PUBLIC_DOMAIN',
  ...
  },
  {
    ...
    title: 'Phù điêu Hội nghị Diên Hồng ý chí muôn dân đánh giặc tại Đền thờ Đức Thánh Trần',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/b6/%C4%90%E1%BB%81n_th%E1%BB%9D_%C4%90%E1%BB%A9c_Th%C3%A1nh_Tr%E1%BA%A7n%2C_Qu%E1%BA%ADn_1%2C_th%C3%A1ng_12_n%C4%83m_2021_%28ph%C3%B9_%C4%91i%C3%AAu_h%E1%BB%99i_ngh%E1%BB%8B_Di%C3%AAn_H%E1%BB%93ng%29_%281%29.jpg',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:%C4%90%E1%BB%81n_th%E1%BB%9D_%C4%90%E1%BB%A9c_Th%C3%A1nh_Tr%E1%BA%A7n,_Qu%E1%BA%ADn_1,_th%C3%A1ng_12_n%C4%83m_2021_(ph%C3%B9_%C4%91i%C3%AAu_h%E1%BB%99i_ngh%E1%BB%8B_Di%C3%AAn_H%E1%BB%93ng)_(1).jpg',
    author: 'Wikimedia Commons Contributor',
    license: 'CC_BY_SA_4_0',
    focalPoint: [0.5, 0.5],
    visualType: 'BATTLE_SCENE',
  },
  {
    ...
    epochKey: 'EPOCH_LY_TRAN',
    topicKeywords: ['bãi cọc bạch đằng 1288', 'bạch đằng 1288', 'trận bạch đằng 1288', 'trận bạch đằng', 'chiến thắng bạch đằng 1288', 'trần hưng đạo đại phá ô mã nhi', 'quảng yên', 'sông bạch đằng'],
    title: 'Bãi cọc gỗ Trận Bạch Đằng năm 1288 thời nhà Trần tại Quảng Yên',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d3/C%E1%BB%8Dc_nh%E1%BB%8Dn_B%E1%BA%A1ch_%C4%90%E1%BA%B1ng_1288.JPG',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:C%E1%BB%8Dc_nh%E1%BB%8Dn_B%E1%BA%A1ch_%C4%90%E1%BA%B1ng_1288.JPG',
    author: 'Viện Khảo cổ học Việt Nam',
    license: 'PUBLIC_DOMAIN',
    focalPoint: [0.5, 0.5],
    visualType: 'ARCHAEOLOGY',
